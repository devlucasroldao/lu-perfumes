...
const styles = {
  card: { background: '#fff', borderRadius: 12, overflow: 'hidden', boxShadow: '0 2px 12px rgba(0,0,0,0.07)', transition: 'transform 0.2s', display: 'flex', flexDirection: 'column' },
  ...
  botao: { marginTop: 8, padding: '10px 0', borderRadius: 8, color: '#fff', fontWeight: 600, fontSize: 13, transition: 'background 0.3s' },
};